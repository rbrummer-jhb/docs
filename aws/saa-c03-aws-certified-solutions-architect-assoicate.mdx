...
- [Monitoring with Amazon Managed Service for Prometheus and Amazon Managed Grafana](#monitoring-with-amazon-managed-service-for-prometheus-and-amazon-managed-grafana)
- [Lab - Implement Advanced CloudWatch Monitoring for a Web Server](#lab---implement-advanced-cloudwatch-monitoring-for-a-web-server)
- [Lab - Work with AWS VPC Flow Logs for Network Monitoring](#lab---work-with-aws-vpc-flow-logs-for-network-monitoring)
...
CloudWatch is a **monitoring** and **observability** platform that was designed to give us insight into our AWS architecture. It allows us to monitor multiple levels of our applications to **identify** potential issues.

### CloudWatch Features

| System Metrics                                                                                    | Application Metrics                                                                         | Alarms                                                                                                                 |
| :------------------------------------------------------------------------------------------------ | :------------------------------------------------------------------------------------------ | :--------------------------------------------------------------------------------------------------------------------- |
| These are metrics that you get out of the box. The more managed the service is, the more you get. | By installing the CloudWatch agent, you can get information from inside your EC2 instances. | What's the point of collecting data if you don't do something with it? Alarms can alert you when something goes wrong. |
...
A tool that allows you to **monitor**, **store**, and **access log files** from a variety of different sources. It gives you the ability to query your logs to look for **potential issues** or data that is relevant to you.
...
| Filter Patterns                                                                         | CloudWatch Logs Insights                                                      | Alarms                                                                               |
| :-------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------- | :----------------------------------------------------------------------------------- |
| You can look for specific terms in your logs. Think 400 errors in your web server logs. | This allows you to query all your logs using a SQL-like interactive solution. | Once you've identified your trends or patterns, it's time to set up alerts for them. |
...
Fully managed AWS service allowing secure data visualizations for instantly **querying, correlating, and visualizing your operational logs, metrics, and traces** from different sources.
...
**Logical Separation**  
**Workspaces** (logical Grafana servers) allow for separation of visualizations and querying.

**AWS Managed**  
AWS handles scaling, setup, maintenance of all workspaces. **You only worry about tasks!**
...
AWS **replicates data across 3 Availability Zones** (AZs) in the same Region. Designed for **availability**.
...
**Data Retention**  
Data stored in workspaces for **150 days** (automatically deleted afterward).
...
Fully managed service for data visualization. Allows instant **querying, correlating**, and **visualizing** of **metrics, logs, and traces**.
...
Both services let AWS handle the **high availability** and **automatic scaling** of infrastructure. Leverage **VPC endpoints** for **secure VPN access**.
...
**Container metric visualizations** (EKS, ECS, or self-hosted Kubernetes clusters), **IoT edge device data**, and **operational teams**.

</Note>

## Lab - Implement Advanced CloudWatch Monitoring for a Web Server
...
<Note>
  **Note**: It can take between 5–15 minutes for flow logs to appear. You can
  continue working through the other lab objectives while you wait for the flow
  logs to populate.
</Note>
...
<Note>
  **Note**: If you entered your real email address, open your email inbox and
  click the **Confirm Subscription** link you received in the SNS email.
</Note>
...
Which of the following represents the metrics that can be viewed using the default CloudWatch metrics?
...
What is a default metric that can be viewed using CloudWatch?
